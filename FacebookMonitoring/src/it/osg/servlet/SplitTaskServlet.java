...
public abstract class SplitTaskServlet extends HttpServlet  {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)	throws IOException {
		...
		try  {
			...
			queue.add(TaskOptions.Builder.withUrl("/" + getJointask()).param("idTransaction", idTransaction).param("numTask", String.valueOf(numTask)).param("from", from).param("to", to).param("pageId", pageId).param("mail", mail).param("timestamp", timestamp));	
