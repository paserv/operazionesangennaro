...
public class Config {
	...
	public static final String HTTP_PROXY_HOST = "proxy.gss.rete.poste";
	public static final String HTTP_PROXY_USER = "servill7";
	public static final String HTTP_PROXY_PASSWORD = "Paolos15";
	public static final String DOMAIN = "rete";
	
	public static final String PAST_PARAM = "passato";
