...
public class IntranetSpiderJobMT extends RunnableQueue {
	...
	public IntranetSpiderJobMT(String url, List<String> linksToVisit, List<String> foundPostLinks) {
		this.url = url;
	...
	public void executeJob() {
		...
		try {
			...
			System.out.println("UnsupportedMimeTypeException CATCHED");
		} catch (HttpStatusException ex1) {
			System.out.println("HttpStatusException CATCHED");
		} catch (IOException e) {
