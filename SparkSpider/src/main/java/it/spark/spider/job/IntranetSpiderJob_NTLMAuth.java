...
public class IntranetSpiderJob_NTLMAuth {
	...
	public IntranetSpiderJob_NTLMAuth(String url, String username, String password, List<String> linksToVisit, List<String> foundPostLinks) {
		this.url = url;
